@php
    ...
    $workers = User::where('dep_id', Auth::user() -> dep_id) -> get();
    ...
    <div class="col-lg-9 bg-body-secondary rounded mt-3 p-2">
		<span class="d-flex justify-content-between">
			<h2 class="perm_panel_switch mx-1"
                panel="perm_panel_report_xlsx">Отправить отчёт в <b>{{$data -> company -> name}}</b></h2>
        ...
        <form id="perm_panel_report_xlsx" action="{{route('mod.report_xlsx', $data -> company -> id)}}" method="post"
            ...
            <div class="form-group mb-2 d-none">
                ...
                <textarea name="note" class="form-control w-100" placeholder="Написать заметки"
