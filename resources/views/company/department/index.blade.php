...
@section('content')
	...
	<div class="row flex-column align-items-center">
		<div class="col-lg-6 bg-body-secondary rounded mt-3 p-2">
			<h2><b>{{$department -> name}} in {{$company -> name}}</b></h2>
			...
			<div class="p-2 border rounded">
				...
				<a href="{{route('company.department.post.create', compact('company', 'department'))}}" class="btn btn-success w-100 mt-1">Create <i class="bi bi-person-vcard"></i></a>
			</div>
