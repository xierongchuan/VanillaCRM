	...
	<div class="tw-flex tw-justify-center">
		<div class="tw-w-full lg:tw-w-2/3 xl:tw-w-1/2">
			<h2 class="tw-text-center tw-mt-6 tw-mb-4 tw-text-2xl tw-font-bold tw-text-gray-800 dark:tw-text-gray-100">
				Изменить отдел <b>{{$department -> name}}</b> in <b>{{$company -> name}}</b>
			</h2>
			<form action="{{route('company.department.modify', compact('company', 'department'))}}" method="post"
				...
				<form-input
					...
					old-value="{{ old('name', $department->name) }}"
				></form-input>
